...
public class NewMonoBehaviourScript1 : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        {
            isdead = true;
            Debug.Log("you killed a innocent dog you monster");
        }

        if (Input.GetKeyDown(KeyCode.R))
        {
            isdead = false;
            Debug.Log("is alive again");
        }
      ...
      void ShowPetInfo()
    {
        ...
        Debug.Log("petWeight"+petWeight);
        Debug.Log("pet is dead" + isdead);
        Debug.Log("==================");
    }
}
